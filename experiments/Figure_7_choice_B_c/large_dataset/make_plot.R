...
# pp
#pp %>% ggsave(file="experiment_1000.pdf", width=7, height=7, units="in")

#p_power %>% ggsave(file="experiment_1000_Bc.pdf", width=7, height=4, units="in")
p_FDR %>% ggsave(file="experiment_1000_Bc_FDR.pdf", width=7, height=3, units="in")
