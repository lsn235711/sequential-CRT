---
title: "Variable Selection with CRT and Selective SeqStep+ Examples"
output:
  html_document:
    df_print: paged
---
...
source("CRT_seqstep/seqstep_CRT_functions.R")
```
...
### Run the procedures
We run the variable selection procedures with CRT and Selective SeqStep+ (exact version and inexact version), and knockoffs as a comparison.
```{r echo=T, results='hide'}
